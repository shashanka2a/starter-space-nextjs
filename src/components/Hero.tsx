  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <svg className="absolute top-20 right-10 w-64 h-64 opacity-10" viewBox="0 0 200 200">
          <path
        ...
        <svg className="absolute bottom-20 left-10 w-48 h-48 opacity-10" viewBox="0 0 200 200">
          <path
